<template>
    <div>
        ...
        <div v-if='this.$store.state.page=="connected"'>
            <ul class='flex'>
                <li v-for="edited in this.$store.state.publicationListe" :key="edited.publications_id" @click='consoling'>
                    <div class='flex column' disabled='disabled'>
                        ...
                        <img disabled='disabled' :src="imageBasisUrl+edited.publications_image" :alt="'image importé : '+imageBasisUrl+edited.publications_image" >
                    </div>
                </li>
            </ul>
...
export default {
    ...
    methods:{
        ...
        consoling(e){
            ...
            console.log('tata', child, 'size', child.leng th)
